...
## Example
If you want a working example you can visit the [example respository](https://gitlab.com/ngocnh/translator-example) for this package. It's a Laravel 5 application that utilies the translator package.
